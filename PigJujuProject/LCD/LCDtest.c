...
/////////////////////////////////////////////////////////////////////////////////
    ...
    while (1)
    {
        ...
        i++;
#if 0
		GUI_ReadBmp("/home/pi/program/PigJujuProject/LCD/pic.bmp");
		Paint_Clear(WHITE);
		usleep(30000);
		GUI_ReadBmp("/home/pi/program/PigJujuProject/LCD/pic1.bmp");

#endif

#if 1
        //Paint_DrawPoint(Maindata->testcnt, 10, BLACK, DOT_PIXEL_1X1, DOT_STYLE_DFT);//240 240
        //Paint_DrawPoint(Maindata->testcnt, 25, BLACK, DOT_PIXEL_2X2, DOT_STYLE_DFT);
        //Paint_DrawPoint(Maindata->testcnt, 40, BLACK, DOT_PIXEL_3X3, DOT_STYLE_DFT);
        //Paint_DrawPoint(Maindata->testcnt, 55, BLACK, DOT_PIXEL_4X4, DOT_STYLE_DFT);

        //Paint_DrawLine(Maindata->testcnt-20, 10, 70, 60, RED, DOT_PIXEL_1X1, LINE_STYLE_SOLID);
        //Paint_DrawLine(Maindata->testcnt-70, 10, 20, 60, RED, DOT_PIXEL_1X1, LINE_STYLE_SOLID);
       // Paint_DrawLine(Maindata->testcnt-70, 15, 170, 55, RED, DOT_PIXEL_1X1, LINE_STYLE_DOTTED);
        //Paint_DrawLine(Maindata->testcnt-50, 35, 190, 35, RED, DOT_PIXEL_1X1, LINE_STYLE_DOTTED);

        //Paint_DrawRectangle(Maindata->testcnt-20, 10, 70, 60, BLUE, DOT_PIXEL_1X1, DRAW_FILL_EMPTY);
        //Paint_DrawRectangle(Maindata->testcnt-85, 10, 130, 60, BLUE, DOT_PIXEL_1X1, DRAW_FILL_FULL);
		...
		Paint_DrawPoint(50, 10, BLACK, DOT_PIXEL_7X7, DOT_STYLE_DFT);//头
		
		Paint_DrawPoint(50, 20, BLACK, DOT_PIXEL_3X3, DOT_STYLE_DFT);//脖子


		Paint_DrawPoint(47, 9, WHITE, DOT_PIXEL_2X2, DOT_STYLE_DFT);//眼睛
		Paint_DrawPoint(53, 9, WHITE, DOT_PIXEL_2X2, DOT_STYLE_DFT);

		Paint_DrawPoint(50, 13, WHITE, DOT_PIXEL_2X2, DOT_STYLE_DFT);//嘴巴

		Paint_DrawPoint(50, 30, BLACK, DOT_PIXEL_8X8, DOT_STYLE_DFT);//嘴巴



//Paint_DrawNum(10, 60, (Maindata->mathSin)*10, &Font16, BLUE, WHITE);
...
/////////////////////////////////////system para show /////////////////////////////////////////////////////////////
		...
		Paint_DrawString_EN(170, 40, Maindata->ip_vpn_google_netspeed, &Font16, WHITE, BLACK);
